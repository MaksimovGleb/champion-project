...
return [
    ...
    'attributes' => [
        ...
        'content' => 'Контент',
        'title' => 'Заголовок',
        'name_alt' => 'Название для клиента',
        'parent_id' => 'Родительская стадия',
        'type_id' => 'Тип обращения',
        'notification' => 'Текст сообщения для клиента',

        'bankDetails.*.bankName' => 'Имя банка',
        'bankDetails.*.bik' => 'БИК банка',
        'bankDetails.*.checkingAccount' => 'Расчётный счёт',
        'bankDetails.*.correspondentAccount' => 'Корреспондентский счёт',

        'PhysicalFace.series' => 'Серия паспорта',
        'PhysicalFace.number' => 'Номер паспорта',
        'PhysicalFace.issuedBy' => 'Кем выдан',
        'PhysicalFace.dateOfIssue' => 'Дата выдачи',
        'PhysicalFace.departmentCode' => 'Код подразделения',
        'PhysicalFace.dob' => 'Дата рождения',
        'PhysicalFace.placeOfRegistration' => 'Место регистрации',
        'PhysicalFace.inn' => 'ИНН',
        'PhysicalFace.snils' => 'СНИЛС',

        'IndividualEntrepreneurFace.series' => 'Серия паспорта',
        'IndividualEntrepreneurFace.number' => 'Номер паспорта',
        'IndividualEntrepreneurFace.issuedBy' => 'Кем выдан',
        'IndividualEntrepreneurFace.dateOfIssue' => 'Дата выдачи',
        'IndividualEntrepreneurFace.departmentCode' => 'Код подразделения',
        'IndividualEntrepreneurFace.dob' => 'Дата рождения',
        'IndividualEntrepreneurFace.placeOfRegistration' => 'Место регистрации',
        'IndividualEntrepreneurFace.inn' => 'ИНН',
        'IndividualEntrepreneurFace.ogrnip' => 'ОГРПИП',

        'LegalFace.shortName' => 'Сокращённое наименование',
        'LegalFace.fullName' => 'Полное наименование',
        'LegalFace.address' => 'Юридический адрес',
        'LegalFace.inn' => 'ИНН',
        'LegalFace.kpp' => 'КПП',
        'LegalFace.ogrn' => 'ОГРН',

        'general.type' => 'Подтип обращения ОП',
        'general.stage' => 'Стадия',
        'general.court' => 'Суд',
        'general.case_number' => '№ дела',
        'general.link_to_case' => 'Ссылка на дело',
        'general.case_status' => 'Статус дела',
        'general.date_next_session' => 'Дата сл. судебного заседания',

        'general.gosuslugi_login' => 'Логин от Госуслуг ',
        'general.gosuslugi_password' => 'Пароль от Госуслуг',

        'general.court_costs' => 'Судебные расходы',

        'bfl.stage' => 'Стадия',
        'bfl.cpo' => 'СРО',
        'bfl.consent_sent' => 'Согласие направлено',
        'bfl.arbitration_id' => 'Арб. управляющий',

        'bfl.court' => 'Суд',
        'bfl.case_number' => '№ дела',
        'bfl.link_to_cad' => 'Ссылка на KAD',
        'bfl.date_next_session' => 'Дата сл. судебного заседания',

        'bfl.gosuslugi_login' => 'Логин от Госуслуг ',
        'bfl.gosuslugi_password' => 'Пароль от Госуслуг',

        'bfl.court_costs' => 'Судебные расходы',
    ],
];

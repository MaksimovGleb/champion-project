                                        ...
                                        <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                            ...
                                            <tr>
                                                <td align="left" style="padding:0;Margin:0;padding-top:10px;padding-bottom:10px">
                                                    <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:24px;color:#333333;font-size:16px"><b>{{ $name }}</b>, спасибо за регистрацию!
                                                        Ваш аккаунт успешно создан. Мы сгенерировали пароль,
                                                        которым можно воспользоваться при первом входе. Пожалуйста, смените его.</p>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                        ...
                                        <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;">
                                            <tr>
                                                <td align="right" style="padding:5px 5px 5px 20px;Margin:0;">
                                                    <p style="Margin:0; line-height:18px; color:#333333; font-family:arial, 'helvetica neue', helvetica, sans-serif; font-size:12px;"><strong>Логин:</strong></p>
                                                </td>
                                                <td align="left" style="padding:5px 20px 5px 5px;Margin:0;">
                                                    <p style="Margin:0; line-height:18px; color:#333333; font-family:arial, 'helvetica neue', helvetica, sans-serif; font-size:12px;">{{ $email }}</p>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="right" style="padding:5px 5px 5px 20px;Margin:0;">
                                                    <p style="Margin:0; line-height:18px; color:#333333; font-family:arial, 'helvetica neue', helvetica, sans-serif; font-size:12px;"><strong>Пароль:</strong></p>
                                                </td>
                                                <td align="left" style="padding:5px 20px 5px 5px;Margin:0;">
                                                    <p style="Margin:0; line-height:18px; color:#333333; font-family:arial, 'helvetica neue', helvetica, sans-serif; font-size:12px;">{{ $password }}</p>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>

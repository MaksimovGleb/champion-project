                                        ...
                                        <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                            <tr>
                                                <td align="center" style="padding:0;Margin:0;padding-bottom:20px;font-size:0px">
                                                    <img src="https://myurist.online/assets/templates/web_tpl/images/logo.svg" alt="Logo"
                                                         style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic;font-size:12px" width="200" title="Logo">
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                        ...
                                        <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                            ...
                                            <tr>
                                                <td align="left" style="padding:0;Margin:0;padding-top:10px;padding-bottom:10px">
                                                    <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:24px;color:#333333;font-size:16px">Уверены, что это необходимо? Чтобы восстановить доступ к учетной записи, пожалуйста, следуйте дальнейшим указаниям.
                                                        В случае, если вы не совершали данное действие, проигнорируйте письмо.
                                                        <br>
                                                    </p>

{{ Form::open(['url' => route('champions.update', $champion->id)]) }}
@csrf
@method('PUT')
    <div class="row">
        <div class="col-xl-12">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control @error('surname') is-invalid @enderror" id="inputSurname" name="surname"
                                           placeholder="Фамилия" value="{{ old('surname') ?? $champion->surname }}">
                                    @error('surname')
                                    <br>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control @error('name') is-invalid @enderror" id="inputName"  name="name"
                                           placeholder="Имя" value="{{ old('name') ?? $champion->name }}">
                                    @error('name')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control @error('patronymic') is-invalid @enderror" id="inputPatronymic" name="patronymic"
                                           placeholder="Отчество" value="{{ old('patronymic') ?? $champion->patronymic }}">
                                    @error('patronymic')
                                    <br>
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control @error('coach') is-invalid @enderror" name="coach"
                                           placeholder="Тренер" value="{{ old('coach') ?? $champion->coach }}">
                                    @error('coach')
                                    <br>
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control @error('category') is-invalid @enderror" name="category"
                                           placeholder="Разряд" value="{{ old('category') ?? $champion->category }}">
                                    @error('category')
                                    <br>
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control @error('weight') is-invalid @enderror" name="weight"
                                           placeholder="Вес" value="{{ old('weight') ?? $champion->weight }}">
                                    @error('weight')
                                    <br>
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="date" class="form-control @error('birth_date') is-invalid @enderror" name="birth_date"
                                           placeholder="Дата рождения" value="{{ old('birth_date') ?? ($champion->birth_date ? \Carbon\Carbon::parse($champion->birth_date)->format('Y-m-d') : '') }}">
                                    @error('birth_date')
                                    <br>
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
